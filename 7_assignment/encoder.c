...
{ 
    ...
    unsigned char * encBuffer = malloc(shell_len);   //reserve buffer for encoded shellcode
    ...
    //encrypt shellcode using integrated function
    ...
    //close handler and release buffer memory
